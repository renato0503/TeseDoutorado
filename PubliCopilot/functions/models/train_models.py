"""
Script de treinamento dos modelos de Machine Learning do Copiloto Algoritmico.

Executa o pipeline completo em 6 etapas:
1. Carrega dados do PNCP (50.000 contratos amostrados)
2. Engenharia de features (7 variaveis preditoras)
3. TF-IDF + Isolation Forest (deteccao de anomalias, 100 arvores)
4. Random Forest Classifier (predicao de risco, 100 arvores)
5. Computacao de SHAP values (TreeExplainer, 500 background)
6. Serializacao dos modelos em models/saved/

Uso:
    python models/train_models.py

Requer:
    - Dados PNCP em dados/processed/pncp_contratos_full.csv
    - Pacotes: scikit-learn, shap, pandas, numpy

References:
    PNCP (2021-2024). Portal Nacional de Contratacoes Publicas.
