...
"""
    ...
    XAI_MAPA = {
        "DO OBJETO": "objeto",
        "DA FUNDAMENTACAO LEGAL": "fundamentacao",
        "DO CRITERIO DE JULGAMENTO": "criterio",
        "DO PRAZO DE VIGENCIA": "vigencia",
        "DAS CONDICOES DE PAGAMENTO": "pagamento",
        "DA GARANTIA": "garantia",
        "DA HABILITACAO": "habilitacao",
        "DAS SANCOES ADMINISTRATIVAS": "sancoes",
        "DA GARANTIA CONTRATUAL": "garantia",
        "DA PROPRIEDADE INTELECTUAL": "propriedade_intelectual",
        "DA CONFIDENCIALIDADE": "confidencialidade",
        "DOS NIVEIS DE SERVICO (SLA)": "sla",
        "DA RESCISAO CONTRATUAL": "rescisao",
        "DOS CRITERIOS DE SUSTENTABILIDADE": "sustentabilidade",
        "DA INOVACAO TECNOLOGICA": "inovacao",
        "DA DOTACAO ORCAMENTARIA": "dotacao",
        "DO RECEBIMENTO DO OBJETO": "recebimento",
        "DA ENCOMENDA TECNOLOGICA": "inovacao",
        "DA TRANSFERENCIA TECNOLOGICA": "inovacao",
        "DA LOGISTICA REVERSA": "sustentabilidade",
        "DA EFICIENCIA ENERGETICA": "sustentabilidade",
        "DO RELATORIO DE IMPACTO": "sustentabilidade",
    }

    st.subheader(" Clausulas Recomendadas")
    for c in clausulas_tipo:
        chave = XAI_MAPA.get(c["titulo"])
        explicacao = obter_explicacao(chave) if chave else obter_explicacao(c["titulo"])
